...
//            Optional<Course> course = courseServiceImplementation.findCourseById(courseId);
//            if (course.isEmpty()){
...
//
//    }
//    public Student saveCourseResult(Student iitStudent, Long courseId, Integer marksObtained) {
...
//        iitResult.setCourse(courseServiceImplementation.findCourseByIdNotOptional(courseId));
