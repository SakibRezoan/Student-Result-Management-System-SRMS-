...
public class MessageConstants {
    public static final String STUDENT_SAVE = "A new Student saved successfully";
    ...
    public static final String STUDENT_RESULT_UPLOAD = "Course Wise Result for students uploaded successfully";
